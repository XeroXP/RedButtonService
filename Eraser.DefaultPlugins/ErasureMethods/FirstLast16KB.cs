	...
	sealed class FirstLast16KB : ErasureMethodBase
	{
		public FirstLast16KB()
		{
			try
			{
				...
				if (Host.Instance.Settings.DefaultFileErasureMethod != Guid)
			...
			{
				Console.WriteLine("The First/last 16KB erasure method requires another erasure method to erase the file.");
			}
		}

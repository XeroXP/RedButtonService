...
namespace Eraser.Manager
{
	...
	public class EntropyPoller
	{
		...
		public EntropyPoller()
		{
            ...
            threadCt = threadCts.Token;
            Thread = new System.Threading.Tasks.Task(Main, threadCt);
		...
		private void Main()
		{
            ...
            while (!threadCts.IsCancellationRequested)
            {
                ...
                System.Threading.Tasks.Task.Delay(2000 + (int)(DateTime.Now.Ticks % 2999)).GetAwaiter().GetResult();
        ...
        private CancellationToken threadCt;
